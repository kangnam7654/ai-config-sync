...
- Work with **backend-dev** on query optimization and schema design
- Advise **data-engineer** on warehouse schema patterns
- Report performance issues to **planner** for prioritization
