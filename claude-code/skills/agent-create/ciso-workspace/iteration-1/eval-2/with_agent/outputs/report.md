...
| Telegram ID (REDACTED) | `openclaw/workspace/USER.md` (line 8) | CONFIDENTIAL (PII under PIPA Art. 2) | None - committed to PUBLIC repo | Removal from public repo, access control | YES - CRITICAL |
