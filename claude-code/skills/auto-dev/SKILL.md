...
flags:
  ...
  - name: --max-loops
    description: "전체 파이프라인의 서브에이전트 호출 상한 (기본 150). 초과 시 체크포인트 저장 + 사용자 보고."
  - name: --budget-tokens
    description: "토큰 사용량 상한 (예: 5M). 초과 시 체크포인트 저장 + 사용자 보고. 생략 시 비활성."
  - name: --resume
    description: "state/auto-dev.yaml의 마지막 체크포인트부터 재개. 완료된 Phase는 스킵하고 미완료 Phase부터 시작."
---
