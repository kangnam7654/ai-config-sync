...
|---|---|---|
| Create card | `kanban-new.py` | `python kanban-new.py "동기화 버그 수정" --priority high --tags bug,sync` |
| View board | (read `BOARD.md`) | If stale, run `kanban-board.py` first to regenerate |
| Move card | `kanban-move.py` | `python kanban-move.py 260429-1503 inprogress` |
| Change metadata | `kanban-set.py` | `python kanban-set.py 260429-1503 --priority high --due 2026-05-15` |
| Delete card | `kanban-rm.py` | `python kanban-rm.py 260429-1503` (moves to Archive; `--hard` for real delete) |
| Validate | `kanban-validate.py` | Used by sync hook; reports schema violations |
| Rename project | `kanban-rename-project.py` | `python kanban-rename-project.py old-name new-name` |
