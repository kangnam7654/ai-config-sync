...
| 4 | **Action Items 측정가능성** | 15% | (integrated만) Action Items가 측정 기준 동반, 막연한 다짐 부재 / (milestone) 다음 마일스톤 메모가 카드 단위 |
...
- **milestone 모드**: "다음 마일스톤 메모" 항목이 _카드/트랙 단위_의 구체성을 가지는지.
  추상적 다짐 1건당 -2.
